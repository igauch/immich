...
export class LibraryService extends BaseService {
  ...
  private async processEntity(filePath: string, ownerId: string, libraryId: string) {
    ...
    return {
      ...
      fileHash,
      originalPath: encryptionInfo.originalPath || assetPath,
      ...
      encryptedPath: encryptionInfo.encryptedPath,
      encryptionIv: encryptionInfo.encryptionIv,
      encryptionSalt: encryptionInfo.encryptionSalt,
    };
  }
